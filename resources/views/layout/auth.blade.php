...
<html lang="en">
  <head>
    ...
    {{-- <link rel="shortcut icon" href="/images/studio-2.jpg"> --}}
    <title>{{ $title }} | SPK Pemilihan Studio</title>
    ...
    <!-- Style -->
    <link rel="stylesheet" href="/assetsLogin2/css/style.css">
...
<!-- Custom styles for this template -->
  ...
  <script src="/assetLogin2/js/popper.js"></script>
  <script src="/assetLogin2/js/bootstrap.min.js"></script>
  <script src="/assetLogin2/js/main.js"></script>
