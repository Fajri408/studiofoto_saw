              ...
              <form method="POST" action="{{ url('/kriteria/update/'.$kriteria->id) }}" class="form-horizontal">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="nama" placeholder="Nama Kriteria" value="{{ $kriteria->nama}}">
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    <label for="label" class="col-sm-2 col-form-label">Label Kriteria</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="label" placeholder="Label Kriteria" value="{{ $kriteria->label}}">
                    </div>
                  </div>
