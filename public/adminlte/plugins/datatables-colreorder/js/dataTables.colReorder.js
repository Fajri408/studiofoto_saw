...
(function (factory) {
     ...
     *  @returns void
     */
    $.fn.dataTableExt.oApi.fnColReorder = function (
        oSettings,
        iFrom,
        iTo,
        drop,
        ...
        for (i = 0, iLen = oSettings.aaSorting.length; i < iLen; i++) {
            oSettings.aaSorting[i][0] =
                aiInvertMapping[oSettings.aaSorting[i][0]];
        }
        ...
        if (oSettings.aoColumns[iFrom].bVisible) {
             ...
             */
            var iVisibleIndex = this.oApi._fnColumnIndexToVisible(
                oSettings,
                iFrom
            );
            ...
            while (iInsertBeforeIndex === null && i < iCols) {
                iInsertBeforeIndex = this.oApi._fnColumnIndexToVisible(
                    oSettings,
                    i
                );
                i++;
    ...
    $.extend(ColReorder.prototype, {
        ...
        /* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
         * Private methods (they are of Studio public in JS, but recommended as private)
         * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
        ...
        _fnMouseDown: function (e, nTh) {
            ...
            this.s.mouse.offsetX =
                this._fnCursorPosition(e, "pageX") - offset.left;
            this.s.mouse.offsetY =
                this._fnCursorPosition(e, "pageY") - offset.top;
        ...
        _fnMouseMove: function (e) {
                ...
                if (
                    Math.pow(
                        Math.pow(
                            ...
                            Math.pow(
                                this._fnCursorPosition(e, "pageY") -
                                    this.s.mouse.startY,
                                2
                            ),
                        0.5
            ...
            for (var i = 1; i < this.s.aoTargets.length; i++) {
                ...
                var prevTargetMiddle =
                    prevTarget.x + (this.s.aoTargets[i].x - prevTarget.x) / 2;
        ...
        _fnRegions: function () {
            ...
            var firstColumnWidth = $(
                aoColumns[firstColumn.index].nTh
            ).outerWidth();
    ...
    $.fn.dataTable.Api.register(
        "colReorder.move()",
        function (from, to, drop, invalidateRows) {
